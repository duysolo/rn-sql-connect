...
- [**Queries**](#queries)
  ...
  - [*ListMoviesByGenre*](#listmoviesbygenre)
...
## GetMovieById
You can execute the `GetMovieById` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `GetMovieById` query requires an argument of type `GetMovieByIdVariables`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `GetMovieByIdData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getMovieById, GetMovieByIdVariables } from '@dataconnect/example';
...
import { connectorConfig, getMovieByIdRef, GetMovieByIdVariables } from '@dataconnect/example';
...
## ListMoviesByGenre
You can execute the `ListMoviesByGenre` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
listMoviesByGenre(vars?: ListMoviesByGenreVariables, options?: ExecuteQueryOptions): QueryPromise<ListMoviesByGenreData, ListMoviesByGenreVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
listMoviesByGenre(dc: DataConnect, vars?: ListMoviesByGenreVariables, options?: ExecuteQueryOptions): QueryPromise<ListMoviesByGenreData, ListMoviesByGenreVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the listMoviesByGenreRef:
```typescript
const name = listMoviesByGenreRef.operationName;
console.log(name);
```

### Variables
The `ListMoviesByGenre` query has an optional argument of type `ListMoviesByGenreVariables`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `ListMoviesByGenre` query returns a `QueryPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `ListMoviesByGenreData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```
### Using `ListMoviesByGenre`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listMoviesByGenre, ListMoviesByGenreVariables } from '@dataconnect/example';

// The `ListMoviesByGenre` query has an optional argument of type `ListMoviesByGenreVariables`:
const listMoviesByGenreVars: ListMoviesByGenreVariables = {
  genre: ..., // optional
  limit: ..., // optional
};

// Call the `listMoviesByGenre()` function to execute the query.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await listMoviesByGenre(listMoviesByGenreVars);
// Variables can be defined inline as well.
const { data } = await listMoviesByGenre({ genre: ..., limit: ..., });
// Since all variables are optional for this query, you can omit the `ListMoviesByGenreVariables` argument.
const { data } = await listMoviesByGenre();
...
// Or, you can use the `Promise` API.
listMoviesByGenre(listMoviesByGenreVars).then((response) => {
  const data = response.data;
  console.log(data.movies);
});
```

### Using `ListMoviesByGenre`'s `QueryRef` function

```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, listMoviesByGenreRef, ListMoviesByGenreVariables } from '@dataconnect/example';
...
// Call the `listMoviesByGenreRef()` function to get a reference to the query.
const ref = listMoviesByGenreRef(listMoviesByGenreVars);
// Variables can be defined inline as well.
const ref = listMoviesByGenreRef({ genre: ..., limit: ..., });
// Since all variables are optional for this query, you can omit the `ListMoviesByGenreVariables` argument.
const ref = listMoviesByGenreRef();

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = listMoviesByGenreRef(dataConnect, listMoviesByGenreVars);
...
## GetMyReviews
You can execute the `GetMyReviews` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
getMyReviews(options?: ExecuteQueryOptions): QueryPromise<GetMyReviewsData, undefined>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
getMyReviews(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetMyReviewsData, undefined>;
...
The `data` property is an object of type `GetMyReviewsData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getMyReviews } from '@dataconnect/example';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getMyReviewsRef } from '@dataconnect/example';
...
## CreateMovie
You can execute the `CreateMovie` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `CreateMovie` mutation requires an argument of type `CreateMovieVariables`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `CreateMovieData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, createMovie, CreateMovieVariables } from '@dataconnect/example';
...
import { connectorConfig, createMovieRef, CreateMovieVariables } from '@dataconnect/example';
...
## UpdateMovie
You can execute the `UpdateMovie` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
updateMovie(vars: UpdateMovieVariables): MutationPromise<UpdateMovieData, UpdateMovieVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `MutationRef` function.
```typescript
updateMovie(dc: DataConnect, vars: UpdateMovieVariables): MutationPromise<UpdateMovieData, UpdateMovieVariables>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the updateMovieRef:
```typescript
const name = updateMovieRef.operationName;
console.log(name);
```

### Variables
The `UpdateMovie` mutation requires an argument of type `UpdateMovieVariables`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
...
```
### Return Type
Recall that executing the `UpdateMovie` mutation returns a `MutationPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `UpdateMovieData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
export interface UpdateMovieData {
  movie_update?: Movie_Key | null;
}
```
### Using `UpdateMovie`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateMovie, UpdateMovieVariables } from '@dataconnect/example';

// The `UpdateMovie` mutation requires an argument of type `UpdateMovieVariables`:
const updateMovieVars: UpdateMovieVariables = {
  id: ..., 
  genre: ..., // optional
  rating: ..., // optional
};

// Call the `updateMovie()` function to execute the mutation.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await updateMovie(updateMovieVars);
// Variables can be defined inline as well.
const { data } = await updateMovie({ id: ..., genre: ..., rating: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await updateMovie(dataConnect, updateMovieVars);

console.log(data.movie_update);

// Or, you can use the `Promise` API.
updateMovie(updateMovieVars).then((response) => {
  const data = response.data;
  console.log(data.movie_update);
});
```

### Using `UpdateMovie`'s `MutationRef` function

```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateMovieRef, UpdateMovieVariables } from '@dataconnect/example';
...
// Call the `updateMovieRef()` function to get a reference to the mutation.
const ref = updateMovieRef(updateMovieVars);
// Variables can be defined inline as well.
const ref = updateMovieRef({ id: ..., genre: ..., rating: ..., });

// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = updateMovieRef(dataConnect, updateMovieVars);
...
## DeleteMovie
You can execute the `DeleteMovie` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `DeleteMovie` mutation requires an argument of type `DeleteMovieVariables`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `DeleteMovieData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, deleteMovie, DeleteMovieVariables } from '@dataconnect/example';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, deleteMovieRef, DeleteMovieVariables } from '@dataconnect/example';
